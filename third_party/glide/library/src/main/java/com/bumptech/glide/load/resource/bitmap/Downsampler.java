...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
     ...
     * @return An integer to pass in to {@link BitmapFactory#decodeStream(InputStream, android.graphics.Rect, android.graphics.BitmapFactory.Options)}
     */
     ...
     * @param options The options to pass to {@link BitmapFactory#decodeStream(InputStream, android.graphics.Rect, android.graphics.BitmapFactory.Options)}
