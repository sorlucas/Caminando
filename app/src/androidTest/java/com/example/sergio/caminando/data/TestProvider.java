...
import com.example.sergio.caminando.provider.RouteDbHelper;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.example.sergio.caminando/weather/
        String type = mContext.getContentResolver().getType(RouteEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.sergio.caminando/weather
        ...
        // content://com.example.sergio.caminando/weather/94074
        ...
        // content://com.example.sergio.caminando/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                RouteEntry.buildRouteUri(testRouteId).buildUpon().appendQueryParameter(RouteEntry.COLUMN_START_DATE,String.valueOf(testDate)).build());
        // vnd.android.cursor.item/com.example.sergio.caminando/weather/1419120000
